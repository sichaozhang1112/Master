function varargout = Mode45(ode,tspan,y0,options,varargin)
...
%%
[ x_1st,x_dot_1st,y_1st,y_dot_1st,theta_1st,theta_dot_1st ] = ReducedToFullState( yout(:,1) );
[ xf_1st,xf_dot_1st,yf_1st,yf_dot_1st ] = HeelAndToe( x_1st,x_dot_1st,y_1st,y_dot_1st,theta_1st,theta_dot_1st );
xft = xf_1st;
CurrentFolder = cd;
fid = fopen([CurrentFolder filesep 'GroundReactionForce.m'],'w');
  ...
  if output_ty || haveOutputFcn 
    ...
    if nout_new > 0
      if output_ty
        ...
        yout(:,idx) = yout_new;
        %%
        [ x_old,x_dot_old,y_old,y_dot_old,theta_old,theta_dot_old ] = ReducedToFullState( yout(:,idx-1) );
        [ xf_old,xf_dot_old,yf_old,yf_dot_old ] = HeelAndToe( x_old,x_dot_old,y_old,y_dot_old,theta_old,theta_dot_old );
        [ x_new,x_dot_new,y_new,y_dot_new,theta_new,theta_dot_new ] = ReducedToFullState( yout(:,idx) );
...
%         fprintf('%s %f\n','xft(4)=',xft(4));
        ...
        %%
        [ u13,Tm17 ] = CalculateU13andTm17FromStates( x_new,x_dot_new,y_new,y_dot_new,theta_new,theta_dot_new );
        U13(idx,:) = u13;
        TM17(idx,:) = Tm17;
        clear u13 Tm17;
        %%
...
CurrentFolder = cd;
xftData = [CurrentFolder filesep 'xft.mat'];
save xftData Xft;
U13Data = [CurrentFolder filesep 'u13.mat'];
save U13Data U13;
TM17Data = [CurrentFolder filesep 'Tm17.mat'];
save TM17Data TM17;
end
