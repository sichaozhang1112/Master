...
% 
% figure();
% plot(linspace(1,100,EndNum),StanceSeq);
% hold on;
% for ii = 1 : 10 : EndNum
%     if StanceSeq(ii) == 1
%         scatter(100*ii/(EndNum),1,'r','o','DisplayName','Heel Strike');
%     elseif StanceSeq(ii) == 2
%         scatter(100*ii/(EndNum),2,'b','d','DisplayName','Flat Foot');
%     elseif StanceSeq(ii) == 3
%         scatter(100*ii/(EndNum),3,'k','^','DisplayName','Heel Off');
%     elseif StanceSeq(ii) == 4
%         scatter(100*ii/(EndNum),4,'m','+','DisplayName','Swing');
%     end 
% end
% hold off;
