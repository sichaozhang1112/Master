...
for ii = 1 : 2
    hold on;
    subplot(3,2,ii)
    plot(linspace(1,60,EndNum-SwingNum),Theta(SwingNum+1:EndNum,2)-Theta(SwingNum+1:EndNum,ii+2),'color',[0 0 1]);
    hold on;
    plot(linspace(60,100,SwingNum),Theta(1:SwingNum,2)-Theta(1:SwingNum,ii+2),'color',[0 0 1]);
    xlabel('gait');
    ylabel(['hip_',num2str(ii)]);
    hold on;
    subplot(3,2,ii+2)
    plot(linspace(1,60,EndNum-SwingNum),Theta(SwingNum+1:EndNum,ii+4)-Theta(SwingNum+1:EndNum,ii+2),'color',[0 0 1]);
    hold on;
    plot(linspace(60,100,SwingNum),Theta(1:SwingNum,ii+4)-Theta(1:SwingNum,ii+2),'color',[0 0 1]);
    xlabel('gait');
    ylabel(['knee_',num2str(ii)]);
    hold on;
    subplot(3,2,ii+4)
    plot(linspace(1,60,EndNum-SwingNum),Theta(SwingNum+1:EndNum,ii+4)-Theta(SwingNum+1:EndNum,ii+6),'color',[0 0 1]);
    hold on;
    plot(linspace(60,100,SwingNum),Theta(1:SwingNum,ii+4)-Theta(1:SwingNum,ii+6),'color',[0 0 1]);
    xlabel('gait');
